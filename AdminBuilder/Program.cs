    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                ConfigurationManager.InitReadConfig(Assembly.Load(AutoFacConfig.model_name));
                ConnectionConfig.InitConnectionConfig();
                OutPutConfigManager.Init();
                using (var scope = AutoFacConfig.AutoFacContainer.BeginLifetimeScope())
                {
                    var form = scope.Resolve<AdminBuilderForm>();
